...
export default function LoginPage() {
    return (
        <div className="auth-wrap min-h-screen flex items-center justify-center relative lg:pt-24 pt-16 font-dm">
            ...
            <div className="absolute top-0 right-0 w-1/2 h-[100vh] bg-cover bg-right xl:flex hidden" style={{ backgroundImage: "url('https://exsit-next.vercel.app/images/auth-bg-1.webp')" }}>
                        ...
                        <div className="w-full text-start">
                            ...
                            <form className="mt-5 space-y-4">
                                ...
                                <div>
                                    <button
                                        type="submit"
                                        className="w-full py-3 px-4 text-white text-base font-semibold rounded-md bg-orange-600 hover:bg-orange-700 transition"
                                    >
                                        Login
                                    </button>
                                </div>
                                ...
                                <div className="flex justify-center gap-3 mt-4">
                                    <button className="w-14 h-14 bg-gray-100 border border-gray-200 rounded-full flex items-center justify-center">
                                        <svg
                                            ...
                                            height="28"
                                            fill="currentColor"
                                            className="bi bi-facebook text-orange-600"
                                            viewBox="0 0 16 16"
                                        >
